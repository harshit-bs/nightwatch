...
module.exports = class Results {
  ...
  constructor(tests = [], opts, settings, skippedTests=[], allScreenedTests=[]) {
    ...
    this.name = capabilities.name || desiredCapabilities.name;
  ...
  get export() {
    ...
    suiteResults.results.startTimestamp = this.startTimestamp;
    suiteResults.results.endTimestamp = this.endTimestamp;
  ...
  setElapsedTime() {
    ...
    if (currentTest) {
      ...
      this.currentTestResult.startTimestamp = startTime;
      this.currentTestResult.endTimestamp = endTime;
