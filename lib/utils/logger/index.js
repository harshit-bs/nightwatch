...
const simpleBeautifyStackTrace = require('../simplebeautifyStackTrace');
...
class Logger {
  ...
  getErrorContent(error, modulepath) {
    ...
    if (stack && showStack) {
      ...
      const simpleBeautified = simpleBeautifyStackTrace(stack, true, modulepath);
      console.log(simpleBeautified)
